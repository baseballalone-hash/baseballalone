...
| **결승 모달 흐름 개선** | 시즌 종료와 동시에 결승 진출 시 *결승 모달 우선* (시즌 종료 화면 위에 덮이는 위화감 제거). 국제대회 휴식기 자동 진행 — yes/no 단계 skip (시즌 중 라이브 모달에서 이미 참가 결정). 결승 라이브 모달 ON/OFF 토글 — OFF 시 자동 시뮬+보상+토스트. |
