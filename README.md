...
- 결승전 (`high_final`, `univ_final`) / 프로 / MLB / NPB: 미적용 (9회 완주 보장)
...
### 다음 작업 후보 (EVENTS.md 우선순위 기반)

| 순위 | 작업 | 난이도 |
|---|---|---|
| **#2** | 마일스톤 자동 검출 + 토스트 (사이클링/노히트/완봉/통산 N안타) | 매우 낮음 |
| **#3** | 시즌 중 이벤트 카탈로그 채우기 (올스타·WBC·올림픽·아시안게임) | 낮음 |
| #4 | 군 입대 (상무/경찰청/사회복무) — 한국 프로 시뮬 필수 분기 | 중 |
| #5 | 포스트시즌 (한국시리즈/와카드, MLB 디비전·리그·월드시리즈) | 중 |
| #6 | 부상 부위 + 후유증 + 토미존 수술 | 중 |
| #7 | 드래프트 라이브 모달 | 낮음 |
| #8 | 멘토/라이벌 영구 NPC | 중-상 |
...
- [ ] 신인 드래프트 (1~10라운드, 계약금) — 현재는 점수 기반 자동 지명만, 라이브 모달 미구현
- [ ] 대학 1~4학년 시즌
- [~] 프로 1·2군 콜업 시스템 — 콜업만 구현, 강등 미구현
- [ ] FA / 트레이드
- [~] 해외 진출 — MLB 만 구현, 일본 프로야구는 stage 만 있고 진입 경로 미구현
- [ ] NPC 시즌 단위 성장 / 은퇴 / 신인 합류 (살아있는 리그)
- [x] 시즌 수상 (8종)  ← v0.2 완료. 골든글러브·실버슬러거 등 추가 가능
- [ ] 통산 기록 마일스톤 (3000안타, 500홈런, 300승, 무안타 게임 등) — **EVENTS.md #2**
- [ ] 군 입대 (상무/경찰청/사회복무) — **EVENTS.md #4** (한국 한정)
- [ ] 포스트시즌 (한국시리즈/와카드/MLB 시리즈) — **EVENTS.md #5**
- [ ] 시즌 중 국제대회 (올스타·WBC·올림픽·아시안게임) — **EVENTS.md #3**
