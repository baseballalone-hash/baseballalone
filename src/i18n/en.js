...
export const en = {
  ...
  hof: {
    ...
    museumTitle:        "🏛 Hall of Fame Museum",
    museumDesc:         "Archive of legends who retired from baseball",
    enterMuseum:        "Enter Museum",
    deleteConfirm:      "Are you sure you want to delete this record?",
    emptySlot:          "Slot Empty (No legend recorded yet)",
    cat: {
      batter:               "Best Batter",
      pitcher:              "Best Pitcher",
      balanced:             "Best Balanced",
      honor:                "Honor of Legend",
