...
export const ko = {
  ...
  hof: {
    ...
    museumTitle:        "🏛 명예의 전당 박물관",
    museumDesc:         "은퇴한 전설적인 선수들의 명예로운 아카이브",
    enterMuseum:        "박물관 입장",
    deleteConfirm:      "정말 이 전설의 기록을 삭제하시겠습니까?",
    emptySlot:          "슬롯 비어있음 (아직 기록된 전설이 없습니다)",
    cat: {
      batter:               "최고의 타자",
      pitcher:              "최고의 투수",
      balanced:             "최고의 밸런스",
  ...
  weekly: {
    ...
    startBattingNotice: "타석을 시작합니다.",
    startBattingDesc: "공이 날아오는 타이밍에 맞춰 화면을 터치하여 스윙하세요!",
    startPitchingNotice: "투구를 시작합니다.",
    startPitchingDesc: "타이밍 링이 가장 작아지는 순간에 맞춰 화면을 터치하여 투구하세요!",
    confirmBtn: "확인",
