...
| 문서 | 관점 | 적는 내용 |
|---|---|---|
| `README.md` | 플레이어/전체 | 게임 소개 + **버전 changelog**(무엇이 바뀌었나, 기능·밸런스) |
| `DEVELOPMENT.md` | 개발자 | 도구·의존성·**테스트 방법**·배포·**에셋 파이프라인**(어떻게 개발·검증하나) |
| `.claude/handoff.md` | 다음 세션 | **현재 진행 상황 + 결정 사항 + 다음 할 일**(지금 어디까지, 다음 뭘) |
| `assets/README.md` | 에셋 | 파일명·스펙 규약 + 생성 프롬프트 시트 |
